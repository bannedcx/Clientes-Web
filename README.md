...
Este proyecto fue desarrollado de manera colaborativa, dividimos el trabajo de la siguiente manera (aclarando la participacion de los dos en el proyecto entero, pero dividiendonos las responsabilidades):
  ...
  - Programación de app.js (coordinacion del estado global del juego), themes.js (catalogos y base de datos de iconos) y game.js (logica matemática, emparejamiento de cartas y demas validaciones). y por ultimo el board.js
...
-Clonar repositorio
  ...
  para usar el programa solo debemos acceder al directorio

  cd Clientes-Web y luego abrimos el archivo index.html y podremos jugarlo
